...
def run_simulation(simulation_time, process_parameters, generate_plots = False):
   ...
   # print("Parametros recibidos en run_simulation:", process_parameters)
    ...
    # Convert monitoring data to DataFrame with optimized types
    df_monitoring = pd.DataFrame(monitoring_data)
    df_monitoring = df_monitoring.astype({
        "time": "int32",
        "arrival_buffer_level": "int32",
        "cleaned_buffer_level": "int32",
        "discarded_cores_buffer_level": "int32",
        "components_buffer_level": "int32",
        "cleaned_components_buffer_level": "int32",
        "good_quality_components_buffer_level": "int32",
        "to_be_repaired_components_buffer_level": "int32",
        "discarded_components_buffer_level": "int32",
        "finished_products_buffer_level": "int32",
        "inspected_finished_products_buffer_level": "int32",
        "discarded_products_buffer_level": "int32",
        "fulfilled_requests": "int32",
        "delayed_requests": "int32"
    })

    # Cleanup memory
    del env, arrival_buffer, cleaned_buffer, discarded_cores_buffer
    gc.collect()
    
    return results, df_monitoring
